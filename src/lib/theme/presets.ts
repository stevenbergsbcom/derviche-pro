...
export const THEME_PRESETS: Record<string, ThemePreset> = {
  ...
  sable: {
    id: 'sable',
    name: 'Sable',
    description: 'Sobre et minimaliste avec des tons sable et ambre',
    colors: {
      light: {
        // Fond sable / taupe clair
        ...
        // Ambre / Doré sombre
        primary: 'oklch(0.55 0.14 60)',
        primaryForeground: 'oklch(0.98 0 0)',

        secondary: 'oklch(0.92 0.025 75)',
        secondaryForeground: 'oklch(0.3 0.04 60)',

        muted: 'oklch(0.92 0.025 75)',
        ...
        border: 'oklch(0.87 0.03 75)',
        input: 'oklch(0.87 0.03 75)',
        ring: 'oklch(0.55 0.14 60)',
        ...
        sidebarBackground: 'oklch(0.94 0.022 75)',
        sidebarForeground: 'oklch(0.35 0.04 60)',
        sidebarBorder: 'oklch(0.87 0.03 75)',
        sidebarAccent: 'oklch(0.9 0.03 75)',
        sidebarAccentForeground: 'oklch(0.3 0.04 60)',
        sidebarPrimary: 'oklch(0.55 0.14 60)',
        sidebarPrimaryForeground: 'oklch(0.98 0 0)',

        derviche: 'oklch(0.55 0.14 60)',
        dervicheLight: 'oklch(0.65 0.12 60)',
        dervicheDark: 'oklch(0.45 0.16 60)',
        gold: 'oklch(0.72 0.14 85)',
        goldLight: 'oklch(0.82 0.12 85)',
      },
      dark: {
        background: 'oklch(0.17 0.025 60)',
        foreground: 'oklch(0.9 0.02 75)',

        card: 'oklch(0.2 0.025 60)',
        cardForeground: 'oklch(0.9 0.02 75)',
        popover: 'oklch(0.2 0.025 60)',
        popoverForeground: 'oklch(0.9 0.02 75)',

        primary: 'oklch(0.65 0.14 60)',
        primaryForeground: 'oklch(0.98 0 0)',

        secondary: 'oklch(0.26 0.025 60)',
        secondaryForeground: 'oklch(0.85 0.02 75)',

        muted: 'oklch(0.26 0.025 60)',
        mutedForeground: 'oklch(0.6 0.02 75)',

        accent: 'oklch(0.68 0.14 85)',
        accentForeground: 'oklch(0.17 0.025 60)',

        border: 'oklch(0.32 0.025 60)',
        input: 'oklch(0.32 0.025 60)',
        ring: 'oklch(0.65 0.14 60)',
        ...
        sidebarBackground: 'oklch(0.14 0.025 60)',
        sidebarForeground: 'oklch(0.8 0.02 75)',
        sidebarBorder: 'oklch(0.26 0.025 60)',
        sidebarAccent: 'oklch(0.22 0.025 60)',
        sidebarAccentForeground: 'oklch(0.85 0.02 75)',
        sidebarPrimary: 'oklch(0.65 0.14 60)',
        sidebarPrimaryForeground: 'oklch(0.98 0 0)',

        derviche: 'oklch(0.65 0.14 60)',
        dervicheLight: 'oklch(0.75 0.12 60)',
        dervicheDark: 'oklch(0.55 0.16 60)',
        gold: 'oklch(0.68 0.14 85)',
        goldLight: 'oklch(0.78 0.12 85)',
      },
    },
  },
};
