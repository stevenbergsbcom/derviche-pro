/**
 * Builder HTML — Rappel J-7
 * Derviche Diffusion
 *
 * Email envoyé 7 jours avant la représentation.
 * Ton : chaleureux, anticipation.
 * Couleur : ambre (#92400e) — rappel doux.
 */
...
export function buildReminder7dHtml(
  ...
  // Couleur thème J-7 : ambre
  const headerBg    = '#92400e';
  const accentColor = '#92400e';
  const subtitleColor = '#fcd34d';
