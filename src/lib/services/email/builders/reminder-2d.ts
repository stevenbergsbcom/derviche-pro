/**
 * Builder HTML — Rappel J-2
 * Derviche Diffusion
 *
 * Email envoyé 2 jours avant la représentation.
 * Ton : plus pressant, rappel d'annulation si besoin.
 * Couleur : orange (#c2410c) — urgence douce.
 */
...
export function buildReminder2dHtml(
  ...
  // Couleur thème J-2 : orange
  const headerBg      = '#c2410c';
  const accentColor   = '#c2410c';
  const subtitleColor = '#fed7aa';
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f4f4f5;padding:32px 0;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        ${bodyBlock}
        ${buildInfoBlock(resolvedInfo, '#c2410c', '#fff7ed', '#fed7aa')}
