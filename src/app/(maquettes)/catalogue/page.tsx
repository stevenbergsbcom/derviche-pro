...
// Données mock de 12 spectacles variés
const spectaclesMock: Spectacle[] = [
  ...
  {
    id: 6,
    title: 'LE VOYAGE D\'ULYSSE',
    company: 'Cie Les Nomades',
    venue: 'Théâtre des Béliers',
    image: 'https://sbcom.fr/derviche2025/a-moi.jpg',
    slug: 'le-voyage-d-ulysse',
    genre: 'Théâtre',
    nextDate: '5 fév. 2025',
    remainingPlaces: 20,
  },
  ...
  {
    id: 8,
    title: 'MARIONNETTES MAGIQUES',
    company: 'Cie Les Poupées',
    venue: 'Théâtre Artéphile',
    image: 'https://sbcom.fr/derviche2025/la-mer.jpg',
    slug: 'marionnettes-magiques',
    genre: 'Marionnettes',
